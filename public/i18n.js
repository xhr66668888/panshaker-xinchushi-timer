...
(function () {
    const T = {
        zh: {
            ...
            thItem: '项目',
            thValue: '数值',
            aiTitle: 'AI 建议售价 (GLM-5.1 旗舰)',
            aiIntro: '基于当前完整场景（成本/价格/税率/租赁政策/中美跨境提成/销量预测）与竞品信息，调用智谱 GLM-5.1 旗舰模型生成推荐定价。旗舰模型推理更深，通常 20-90 秒返回。',
        ...
        en: {
            ...
            thItem: 'Item',
            thValue: 'Value',
            aiTitle: 'AI Pricing Suggestion (GLM-5.1 flagship)',
            aiIntro: 'Calls Zhipu GLM-5.1 flagship with the full scenario (costs/prices/tax/lease policy/cross-border commission/forecast) plus competitor info. Flagship reasoning depth typically returns in 20-90 seconds.',
