...
(function () {
    const T = {
        zh: {
            ...
            breakevenTitle: '保本线 (年度)',
            breakevenBuyoutLabel: '全部卖买断',
            breakevenLeaseLabel: '全部做租赁',
            tabForecast: '销量预测',
            tabEmployees: '员工',
            employeesTitle: '员工薪酬',
            addEmployeeBtn: '+ 添加员工',
            ...
            dimCBM: '体积:',
            dimWeight: '毛重:',
            kpiBuyoutPrice: '买断售价 (税前)',
            kpiBuyoutPriceHint: 'Sales Tax 由客户州代收代缴，不吃公司收入',
            kpiLeaseRentHint: 'Sales Tax 另行向客户代收',
            ...
            thItem: '项目',
            thValue: '数值',
            aiTitle: 'AI 经营助手 (GLM-5.1)',
            aiIntro: '策略对话与定价建议均使用智谱 GLM-5.1；定价任务通常 20–90 秒返回。',
            aiTabStrategy: '策略对话',
            aiTabPricing: '定价建议',
            aiStrategyIntro: '选择经营方法论（Skill），在对话中制定策略；可选附带当前财务场景摘要。',
            aiPricingIntro: '基于当前完整场景（成本/价格/税率/租赁政策/中美跨境提成/销量预测）与竞品信息，调用智谱 GLM-5.1 旗舰模型生成推荐定价 JSON。通常 20–90 秒返回。',
            aiSkillLabel: '方法论',
            aiAttachScenario: '附带当前场景摘要（精简 JSON）',
            aiChatPlaceholder: '描述你的目标、约束或问题…',
            aiChatSend: '发送',
            aiChatClear: '清空对话',
            aiSkillsLoadFailed: '无法加载方法论列表',
            aiSkillsLoading: '正在加载…',
            aiSkillsRetry: '重试',
            aiSkillsLoadHint: '请用 Node 启动本站点（例如在项目根目录执行 node index.js），并用浏览器访问该服务上的财务页；不要直接用 file:// 打开 HTML。若已部署到服务器，请确认进程工作目录下存在 ai-ceo 目录（或 public/ai-ceo）。',
            aiSkillsEmptyDeploy: '（未找到 Skill）服务器上未扫描到 ai-ceo/*/SKILL.md',
            aiChatEmptyHint: '选择方法论后输入消息开始对话。',
            aiChatRoleUser: '你',
            aiChatRoleAssistant: '助手',
            aiChatNeedInput: '请选择方法论并输入消息。',
            aiChatThinking: 'GLM 推理中…',
            aiChatKickFail: '启动对话任务失败：',
            aiChatJobExpired: '任务已过期，请重试发送。',
            aiChatDone: '已完成',
            aiChatBadReply: '未收到有效回复',
            aiChatTimeout: '轮询超时（5 分钟），请重试。',
            aiCallBtn: '生成定价建议',
            aiApplyBtn: '应用到当前场景',
            saveAsTitle: '另存为新场景',
            saveAsNameLabel: '场景名:',
        ...
        en: {
            ...
            kpiEtf: 'Early term. fee (pre-tax)',
            kpiActivationFee: 'Activation fee (pre-tax, non-refundable)',
            ...
            breakevenTitle: 'Break-even (annual)',
            breakevenBuyoutLabel: 'All outright',
            breakevenLeaseLabel: 'All lease',
            ...
            kpiBuyoutPrice: 'Outright price (pre-tax)',
            kpiBuyoutPriceHint: 'Sales tax is collected and remitted by you on behalf of the customer state; not revenue',
            kpiLeaseRentHint: 'Sales tax billed separately to customer',
            kpiLeaseFirstPay: 'Lease first-pay',
            kpiLeaseRent: 'Monthly rent (pre-tax)',
            ...
            alertLeaseUnitCash: 'Per-unit month-1 cash',
            ...
            thItem: 'Item',
            thValue: 'Value',
            aiTitle: 'AI Business Copilot (GLM-5.1)',
            aiIntro: 'Strategy chat and pricing both use Zhipu GLM-5.1; pricing jobs often return in 20–90s.',
            aiTabStrategy: 'Strategy chat',
            aiTabPricing: 'Pricing',
            aiStrategyIntro: 'Pick a playbook (Skill) and chat to shape strategy; optionally attach a lean JSON snapshot of the finance scenario.',
            aiPricingIntro: 'Calls GLM-5.1 with the full scenario (costs, tax, lease, commission, forecast) plus competitor framing; returns structured pricing JSON in about 20–90s.',
            aiSkillLabel: 'Playbook',
            aiAttachScenario: 'Attach lean scenario JSON',
            aiChatPlaceholder: 'Goals, constraints, or questions…',
            aiChatSend: 'Send',
            aiChatClear: 'Clear chat',
            aiSkillsLoadFailed: 'Could not load playbook list',
            aiSkillsLoading: 'Loading…',
            aiSkillsRetry: 'Retry',
            aiSkillsLoadHint: 'Start the app with Node (e.g. node index.js) and open the finance page from that server — not as a file:// URL. On deploy, ensure the ai-ceo folder (or public/ai-ceo) exists next to index.js.',
            aiSkillsEmptyDeploy: '(No skills) No ai-ceo/*/SKILL.md found on the server',
            aiChatEmptyHint: 'Pick a playbook and type a message to start.',
            aiChatRoleUser: 'You',
            aiChatRoleAssistant: 'Assistant',
            aiChatNeedInput: 'Pick a playbook and enter a message.',
            aiChatThinking: 'GLM is thinking…',
            aiChatKickFail: 'Failed to start chat job: ',
            aiChatJobExpired: 'Job expired; send again.',
            aiChatDone: 'Done',
            aiChatBadReply: 'Empty or invalid reply',
            aiChatTimeout: 'Timed out after 5 minutes; try again.',
            aiCallBtn: 'Generate pricing JSON',
