...
(function () {
    const T = {
        zh: {
            ...
            thItem: '项目',
            thValue: '数值',
            aiTitle: 'AI 建议售价 (GLM-4.6V)',
            aiIntro: '基于当前完整场景（成本/价格/税率/租赁政策/中美跨境提成/销量预测）与竞品信息，调用智谱 GLM-4.6V 生成推荐定价。',
        ...
        en: {
            ...
            saveAsBtn: 'Save As',
            cashflowWindowLabel: 'Cashflow window:',
            ...
            thItem: 'Item',
            thValue: 'Value',
            aiTitle: 'AI Pricing Suggestion (GLM-4.6V)',
            aiIntro: 'Calls Zhipu GLM-4.6V with the full scenario (costs/prices/tax/lease policy/cross-border commission/forecast) plus competitor info to produce pricing recommendations.',
